...
`release/beta-2026-05-16/manifest.json`. It is the source of truth
...
node scripts/generate-release-checksums.mjs \
  ...
  --output release/beta-2026-05-16/SHA256SUMS \
  --update-manifest
```
...
node scripts/verify-release-checksums.mjs \
  --manifest release/beta-2026-05-16/manifest.json \
  --artifact-root /path/to/release-artifacts \
  --checksums release/beta-2026-05-16/SHA256SUMS
```
...
```sh
node --test scripts/__tests__/os-release-scripts.test.mjs
```
