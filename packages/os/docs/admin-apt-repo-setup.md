...
`release/apt-repo/elizaos-apt-public.asc` in the main
...
curl -fsSL https://raw.githubusercontent.com/elizaOS/os/main/packages/os/release/apt-repo/elizaos-apt-public.asc \
...
- [docs/ci-cd-production-plan.md](./ci-cd-production-plan.md) —
  broader release pipeline status.
- [docs/verify-iso-download.md](./verify-iso-download.md)
