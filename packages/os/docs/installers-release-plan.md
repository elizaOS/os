...
- Linux live USB / VM mechanics: `linux/`
- Android system image and vendor layer: `android/`
- Shared contracts used by OS surfaces: `shared-system/`
